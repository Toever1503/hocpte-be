...
import hocpte.configs.jwt.JwtAuthenticationProvider;
import hocpte.configs.jwt.JwtFilter;
...
public class WebSecurityConfiguration {
    ...
    private final RequestMatcher PUBLIC_URLS = new OrRequestMatcher(
            ...
            new AntPathRequestMatcher("/test/upload"),

            // for course
            new AntPathRequestMatcher("/api/v1/courses/filter**"),
